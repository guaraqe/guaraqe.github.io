...
summary: Setting up IHaskell kernel in JupyterLab for interactive Haskell data analysis
tags: "Haskell, Tooling, Data Science"
---

This blog post was written for [Tweag](https://www.tweag.io) with Matthias
Meschede on IHaskell. You can find it the original
[here](https://www.tweag.io/blog/2019-01-23-jupyterlab-ihaskell/).
...
![Vega Wordcloud](./img/jupyterlab-json.png)
...
![Vega Wordcloud](./img/jupyterlab-wordcloud.png)
